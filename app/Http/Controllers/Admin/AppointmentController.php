...
class AppointmentController extends Controller
{
    ...
    public function create()
    {
        ...
        // In create, show only discounts that are active and not expired (global)
        $discounts = Discount::all()->filter(fn($d) => $d->isAvailable()); // global availability

        return view('admin.appointments.create', compact('customers', 'services', 'employees', 'discounts'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $customMessages = [
            ...
            'appointment_time.regex' => 'The appointment time must be between 6:00 AM and 7:00 PM.',
        ];
        ...
        try {
            DB::transaction(function () use ($request, &$customer, &$selectedDiscountId, &$total, &$loyaltyDiscountUsed) {
                ...
                $appointment = Appointment::create([
                    ...
                    'payment_status' => $request->payment_method == 'cash' ? 'pending' : 'for_validation', // FIXED
                    'total_amount' => $total,
    ...
    public function edit(Appointment $appointment)
    {
        ...
        $discounts = Discount::all()->map(function ($discount) use ($appointment, $currentDiscountId) {
            ...
            $discount->customer_used = $customer_used; // for display
        ...
        return view('admin.appointments.edit', compact('appointment', 'customers', 'services', 'employees', 'discounts'));
    }
    ...
    public function update(Request $request, Appointment $appointment)
    {
        ...
        return redirect()->route('admin.appointments.show', $appointment)->with('success', 'Appointment updated.');
    }

    public function destroy(Appointment $appointment)
    {
        $appointment->delete(); // soft delete
        return redirect()->route('admin.appointments.index')->with('success', 'Appointment archived.');
    }
    ...
    public function archived(Request $request)
    {
        ...
        $appointments = $query->orderBy('deleted_at', 'desc')->paginate(10);
        return view('admin.appointments.archived', compact('appointments'));
    }
    ...
    public function restore($id)
    {
        ...
        return redirect()->route('admin.appointments.archived')->with('success', 'Appointment restored.');
    }
