...
class CustomerController extends Controller
{
    ...
    public function destroy(Customer $customer)
    {
        ...
        return redirect()->route('admin.customers.index')->with('success', 'Customer archived.');
    }
    ...
    public function restore($id)
    {
        ...
        return redirect()->route('admin.customers.archived')->with('success', 'Customer restored and emailed about their account reactivation.');
    }
    ...
    public function history(Customer $customer)
    {
        ...
        return view('admin.customers.history', compact('customer', 'appointments'));
    }
}
